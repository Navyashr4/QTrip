  ...
  return (
    ...
    bg-white shadow-md p-5 md:px-10">
        ...
        rounded-full py-2 md:shadow-sm'>
            ...
            <SearchIcon onClick={search} className='hidden md:inline-flex h-8 bg-red-400 text-white 
        ...
        {searchInput && (
            <div className='flex flex-col col-span-3 mx-auto'>
                ...
                <div className='flex items-center border-b mb-4'>
                    ...
                    <input type='number' className='w-12 pl-2 border-2 border-stone-200
                    rounded-md outline-none text-red-400'
                    value={noOfGuests}
                    min={1}
